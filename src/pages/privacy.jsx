  ...
  return (
    <SideBar>
      <div className='px-4 py-8 max-w-5xl mx-auto text-justify overflow-auto'>
        ...
        <p className='italic'>Last updated: March 07, 2022</p>
        <p className='pt-6'>
        ...
        <br />
        <h1 className='text-primary text-bold text-xl font-bold py-2'>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Loop Not Luck, 64 Knightsbridge,
              London SW1X 7JF.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Loop Not Luck, accessible from{' '}
              <a
        ...
        <ul>
          <li>By email: hello@loopnotluck.com</li>
        </ul>
      </div>
      <Footer />
    </SideBar>
