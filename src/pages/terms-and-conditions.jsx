  ...
  return (
    <SideBar>
      <div className='px-4 py-8 max-w-5xl mx-auto text-justify overflow-auto'>
        <h1 className='text-primary text-bold text-3xl font-bold'>
          TERMS AND CONDITIONS
        </h1>
        <p className='italic'>Last updated August 26, 2020</p>
        <p className='pt-6'>1. &nbsp; Agreement to Terms &nbsp; &nbsp;&nbsp;</p>
        <p>
        ...
        <p>
          5.2 &nbsp;Except as expressly provided in these Terms and Conditions,
        ...
        <p>
          ...
          Site; and/or (b) make for any purpose including error correction, any
        ...
        <p>
          ...
          way a burden to our systems; and (5) otherwise manage the Site in a
        ...
        <p>
          8.2 &nbsp;We cannot guarantee the Site and Services will be available
          at all times. We may experience hardware, software, or other problems
        ...
        <p>
          ...
          usage, a course of dealing, or common law) in connection with the Site
          and Services and your use thereof including, without limitation, the
          implied warranties of satisfactory quality, fitness for a particular
          purpose and non-infringement are excluded to the fullest extent
        ...
        <p>
          ...
          any cause of action arising. Different limitations and exclusions of
          liability will apply to liability arising as a result of the supply of
          any products to you, which will be set out in our Terms and conditions
          of supply. &nbsp; &nbsp;&nbsp;
        </p>
        ...
        <p>
          12.10 &nbsp;In order to resolve a complaint regarding the Services or
