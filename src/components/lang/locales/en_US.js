...
module.exports = {
  ...
  /* 02.User Login, Logout, Register, Forgot Password*/
  'user.login-title': 'Login',
  'user.login': 'login',
  'user.register': 'Register',
  'user.registerSmall': 'register',
  ...
  'user.or': 'or',
  'user.loginWith': 'Sign in',
  'user.registerWith': 'Sign Up',
  'user.redirectSignUp': 'If you are not a member, please ',
  ...
  'onboarding.nextVariant3': 'Next: Complete Onboarding',
  ...
  // 'onboarding.paymentHeader': 'Pricing Packages',\  'onboarding.paymentHeader': 'Pricing Packages',
  'onboarding.paymentHeader': 'Confirm Onboarding',
