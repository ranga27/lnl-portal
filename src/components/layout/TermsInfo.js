export const TermsInfo = () => {
  return (
    <div className='text-sm'>
      <p className='italic my-4'>Last updated August 26, 2020</p>
      ...
      <p>
        ...
        entity (you), and Loop Not Limited, located at 63-66 Hatton Garden, 5th
        Floor Suite 23, London, EC1N 8LE, concerning your access to and use of
        the Loop Not Luck{' '}
        <a
          href='https://loopnotluck.com/'
          rel='noreferrer'
          target='_blank'
          className='text-[#F7B919]'
        >
      ...
      <p>
        The Site provides the following services: career-related services. You
      ...
      <p>
        ...
        well as any supplemental terms and conditions or documents that may be
      ...
      <p>
        ...
        an updated &ldquo;Revised&rdquo; date and the updated version will be
      ...
      <p>
        ● &nbsp;Our Privacy Notice sets out the terms on which we process any
      ...
      <p>
        ● Our Acceptable Use Policy sets out the permitted uses and prohibited
      ...
      <p>
        ● If you purchase from the Site, our terms and conditions of supply will
        apply to the &nbsp;
      </p>
      <p>
        ● Certain parts of this Site can be used only on payment of a fee. If
        you wish to use such Services, you will, in addition to our Terms and
      ...
      <p>
        ...
        that for which we make the site and our services available. The Site may
      ...
      <p>
        ...
        information you submit will be true, accurate, current, and complete and
        relate to you and not a third party; (b) you will maintain the accuracy
        of such information and promptly update such information as necessary;
        (c) you will keep your password confidential and will be responsible for
        all use of your password and account; (d) you have the legal capacity
        and you agree to comply with these Terms and Conditions; and (e) you are
      ...
      <p>
        ...
        combine your User Content with other content for use within the Site and
      ...
      <p>
        ...
        with other users of the Site you shall comply with our Acceptable Use
        Policy.&nbsp;
      </p>
      <p>
        4.4 &nbsp;You warrant that any User Content does comply with our
        Acceptable Use Policy, and you will be liable to us and indemnify us for
        any breach of that warranty. This means you will be responsible for any
        loss or damage we suffer as a result of your breach of this
        warranty.&nbsp;
      </p>
      <p>
        4.5 &nbsp;We have the right to remove any User Content you put on the
        Site if, in our opinion, such User Content does not comply with the
        Acceptable Use Policy. &nbsp;
      </p>
      <p>
        ...
        time. User Content has not been verified or approved by us and the views
      ...
      <p>
        ...
        <a href='mailto:hello@loopnotluck.com'>hello@loopnotluck.com</a> or use
        the take down or report button. &nbsp; &nbsp;&nbsp;
      </p>
      <p>5. &nbsp; Our content &nbsp; &nbsp;</p>
      <p>
      ...
      <p>
        ...
        granted a limited licence to access and use the Site and Our Content and
      ...
      <p>
        5.4 &nbsp;You shall not (a) try to gain unauthorised access to the Site
        or any networks, servers or computer systems connected to the Site;
      ...
      <p>
        ...
        operated by third parties.We do not have any influence or control over
        any such third party websites or applications or the third party
        operator. We are not responsible for and do not endorse any third party
      ...
      <p>
        ...
        these Terms and Conditions; (3) refuse, restrict access to or
        availability of, or disable (to the extent technologically feasible) any
        of your Contributions; (4) remove from the Site or otherwise disable all
        files and content that are excessive in size or are in any way a burden
        to our systems; and (5) otherwise manage the Site in a manner designed
      ...
      <p>
        ...
        technology, computer programs and platform to access the Site and you
      ...
      <p>
        ...
        and support the Site or Services or to supply any corrections, updates,
        or releases.&nbsp;
      </p>
      <p>
        ...
        Services, including descriptions, pricing, availability, and various
      ...
      <p>
        ...
        as-available basis. You agree that your use of the Site and/or Services
      ...
      <p>
        ...
        completeness of the Site&rsquo;s content and are not liable for any (1)
        errors or omissions in content: (2) any unauthorized access to or use of
      ...
      <p>
        ...
        the sum of &pound;5000 or (b) the amount paid, if any, by you to us for
        the Services/Site during the six (6) month period prior to any cause of
        action arising. Different limitations and exclusions of liability will
        apply to liability arising as a result of the supply of any products to
      ...
      <p>
        ...
        effect while you use the Site or Services or are otherwise a user of the
        Site, as applicable. You may terminate your use or participation at any
      ...
      <p>
        ...
        notice or liability, deny access to and use of the Site and the Services
      ...
      <p>
        ...
        out in this Section 9, you are prohibited from registering and creating
      ...
      <p>
        (a) The licence granted to you for our mobile application is limited to
      ...
      <p>
        ...
        Terms and Conditions or as otherwise required under applicable law. You
      ...
      <p>
        (c) In the event of any failure of the mobile application to conform to
      ...
      <p>
        (d) You represent and warrant that (i) you are not located in a country
      ...
      <p>
        ...
        rules posted by us on the Site or in respect to the Services constitute
      ...
      <p>
        12.8 &nbsp;The following are trademarks of Loop Not Luck Limited. You
      ...
      <p>
        ...
        contact us by email at hello@loopnotluck.com or by post to:&nbsp;
      </p>
      <p>
        <br />
      </p>
