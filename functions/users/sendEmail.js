...
exports.sendEmail = ({ to, from, subject, message, firstName, lastName }) => {
  const mailOptions = {
    to,
    from,
    subject,
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="mainTitle">
                            <h5 class="text" style="color:#000;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:20px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0">Hi ${
                              lastName + ' ' + firstName
                            }</h2>
                          </td>
                        </tr>
